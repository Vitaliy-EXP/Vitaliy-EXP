...
Frontend-разработчик (junior). Завершил переподготовку в Яндекс.Практикуме по направлению «Фронтенд-разработчик». Создаю адаптивные интерфейсы, работаю с React, знаком с TypeScript и настройкой сборки. В портфолио — проекты по вёрстке, интерактивные SPA и крупный учебный проект «Stellar Burgers» с Redux и тестированием.
...
Краснодар, Россия  
Тел.: +7 (967) 652-33-22  
E-mail: bva91@mail.ru  
GitHub: https://github.com/Vitaliy-EXP

## Занимаюсь сейчас
Закладываю и документирую портфолио: добавляю README к проектам и готовлю ATS-дружественное резюме для откликов на junior/middle вакансии.
